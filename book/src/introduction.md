...
This book is the **public front door**. It owns no skill law, no loop law, and no harness spec. Each chapter is a link to the remote that does.
...
3. [Skills catalog](skills/overview.md) → skills
4. [Harness](harness/overview.md) → harness
